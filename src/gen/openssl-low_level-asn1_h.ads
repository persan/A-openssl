...
package OpenSSL.Low_Level.asn1_h is
   ...
   function i2a_ASN1_INTEGER (bp : access OpenSSL.Low_Level.bio_h.BIO; a : access OpenSSL.Low_Level.asn1_h.asn1_string_st) return int;  -- openssl/asn1.h:904
   ...
   function i2a_ASN1_ENUMERATED (bp : access OpenSSL.Low_Level.bio_h.BIO; a : access OpenSSL.Low_Level.asn1_h.asn1_string_st) return int;  -- openssl/asn1.h:906
   ...
   function i2a_ASN1_OBJECT (bp : access OpenSSL.Low_Level.bio_h.BIO; a : access ASN1_OBJECT) return int;  -- openssl/asn1.h:908
   ...
   function BN_to_ASN1_INTEGER (bn : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM; ai : access OpenSSL.Low_Level.asn1_h.asn1_string_st) return access OpenSSL.Low_Level.asn1_h.asn1_string_st;  -- openssl/asn1.h:920
   pragma Import (C, BN_to_ASN1_INTEGER, "BN_to_ASN1_INTEGER");

   function ASN1_INTEGER_to_BN (ai : access constant OpenSSL.Low_Level.asn1_h.asn1_string_st; bn : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM) return access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/asn1.h:921
   ...
   function BN_to_ASN1_ENUMERATED (bn : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM; ai : access OpenSSL.Low_Level.asn1_h.asn1_string_st) return access OpenSSL.Low_Level.asn1_h.asn1_string_st;  -- openssl/asn1.h:925
   pragma Import (C, BN_to_ASN1_ENUMERATED, "BN_to_ASN1_ENUMERATED");

   function ASN1_ENUMERATED_to_BN (ai : access OpenSSL.Low_Level.asn1_h.asn1_string_st; bn : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM) return access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/asn1.h:926
   ...
   function ASN1_UTCTIME_print (fp : access OpenSSL.Low_Level.bio_h.BIO; a : access constant OpenSSL.Low_Level.asn1_h.asn1_string_st) return int;  -- openssl/asn1.h:1026
   pragma Import (C, ASN1_UTCTIME_print, "ASN1_UTCTIME_print");

   function ASN1_GENERALIZEDTIME_print (fp : access OpenSSL.Low_Level.bio_h.BIO; a : access constant OpenSSL.Low_Level.asn1_h.asn1_string_st) return int;  -- openssl/asn1.h:1027
   pragma Import (C, ASN1_GENERALIZEDTIME_print, "ASN1_GENERALIZEDTIME_print");

   function ASN1_TIME_print (fp : access OpenSSL.Low_Level.bio_h.BIO; a : access constant OpenSSL.Low_Level.asn1_h.asn1_string_st) return int;  -- openssl/asn1.h:1028
   pragma Import (C, ASN1_TIME_print, "ASN1_TIME_print");

   function ASN1_STRING_print (bp : access OpenSSL.Low_Level.bio_h.BIO; v : System.Address) return int;  -- openssl/asn1.h:1029
   ...
   function ASN1_bn_print
     (bp : access OpenSSL.Low_Level.bio_h.BIO;
      ...
      num : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
   ...
   function BIO_f_asn1 return access OpenSSL.Low_Level.bio_h.BIO_METHOD;  -- openssl/asn1.h:1134
   pragma Import (C, BIO_f_asn1, "BIO_f_asn1");

   function BIO_new_NDEF
     (c_out : access OpenSSL.Low_Level.bio_h.BIO;
      val : System.Address;
      it : System.Address) return access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/asn1.h:1136
   ...
   function SMIME_write_ASN1
     (the_bio : access OpenSSL.Low_Level.bio_h.BIO;
      val : System.Address;
      data : access OpenSSL.Low_Level.bio_h.BIO;
      flags : int;
      ctype_nid : int;
      econt_nid : int;
   ...
   function SMIME_text (c_in : access OpenSSL.Low_Level.bio_h.BIO; c_out : access OpenSSL.Low_Level.bio_h.BIO) return int;  -- openssl/asn1.h:1149
