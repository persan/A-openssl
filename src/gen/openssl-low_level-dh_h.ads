...
package OpenSSL.Low_Level.dh_h is
   ...
   type dh_method is record
      ...
      bn_mod_exp : access function
           (arg1 : access constant OpenSSL.Low_Level.dh_h.dh_st;
            ...
            arg6 : System.Address;
            arg7 : access OpenSSL.Low_Level.ossl_typ_h.BN_MONT_CTX) return int;  -- openssl/dh.h:107
      ...
      generate_params : access function
           (arg1 : System.Address;
            arg2 : int;
            arg3 : int;
            arg4 : access OpenSSL.Low_Level.ossl_typ_h.BN_GENCB) return int;  -- openssl/dh.h:114
   end record;
   ...
   type dh_st is record
      ...
      p : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/dh.h:123
      g : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/dh.h:124
      length : aliased long;  -- openssl/dh.h:125
      pub_key : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/dh.h:126
      priv_key : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/dh.h:127
      flags : aliased int;  -- openssl/dh.h:129
      method_mont_p : access OpenSSL.Low_Level.ossl_typ_h.BN_MONT_CTX;  -- openssl/dh.h:130
      q : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/dh.h:132
      j : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/dh.h:133
      seed : access unsigned_char;  -- openssl/dh.h:134
      seedlen : aliased int;  -- openssl/dh.h:135
      counter : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/dh.h:136
   ...
   function DH_generate_parameters_ex
     (the_dh : access OpenSSL.Low_Level.dh_h.dh_st;
      prime_len : int;
      generator : int;
      cb : access OpenSSL.Low_Level.ossl_typ_h.BN_GENCB) return int;  -- openssl/dh.h:194
   ...
   function DH_check_pub_key
     (the_dh : access constant OpenSSL.Low_Level.dh_h.dh_st;
      pub_key : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
   ...
   function DHparams_print (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access constant OpenSSL.Low_Level.dh_h.dh_st) return int;  -- openssl/dh.h:206
