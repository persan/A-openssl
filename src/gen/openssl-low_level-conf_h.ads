...
package OpenSSL.Low_Level.conf_h is
   ...
   type conf_method_st is record
      ...
      load_bio     : access function
        (arg1 : access OpenSSL.Low_Level.conf_h.conf_st;
         arg2         : access OpenSSL.Low_Level.bio_h.bio_st;
         arg3         : access long) return int;  -- openssl/conf.h:95
      dump         : access function (arg1 : access constant OpenSSL.Low_Level.conf_h.conf_st; arg2 : access OpenSSL.Low_Level.bio_h.bio_st) return int;  -- openssl/conf.h:96
   ...
   function CONF_dump_bio (conf : access lhash_st_CONF_VALUE; c_out : access OpenSSL.Low_Level.bio_h.bio_st) return int;  -- openssl/conf.h:138
   ...
   function NCONF_dump_bio (the_conf : access constant OpenSSL.Low_Level.conf_h.conf_st; c_out : access OpenSSL.Low_Level.bio_h.bio_st) return int;  -- openssl/conf.h:172
