...
package OpenSSL.Low_Level.pkcs7_h is
   ...
   function d2i_PKCS7_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; p7 : System.Address) return access PKCS7;  -- openssl/pkcs7.h:288
   pragma Import (C, d2i_PKCS7_bio, "d2i_PKCS7_bio");

   function i2d_PKCS7_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; p7 : access PKCS7) return int;  -- openssl/pkcs7.h:289
   ...
   function PKCS7_dataInit (p7 : access PKCS7; the_bio : access OpenSSL.Low_Level.bio_h.BIO) return access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/pkcs7.h:326
   pragma Import (C, PKCS7_dataInit, "PKCS7_dataInit");

   function PKCS7_dataFinal (p7 : access PKCS7; the_bio : access OpenSSL.Low_Level.bio_h.BIO) return int;  -- openssl/pkcs7.h:327
   pragma Import (C, PKCS7_dataFinal, "PKCS7_dataFinal");

   function PKCS7_dataDecode
     (p7 : access PKCS7;
      pkey : access OpenSSL.Low_Level.evp_h.evp_pkey_st;
      in_bio : access OpenSSL.Low_Level.bio_h.BIO;
      pcert : access OpenSSL.Low_Level.x509_h.x509_st) return access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/pkcs7.h:328
   ...
   function PKCS7_verify
     (p7 : access PKCS7;
      ...
      indata : access OpenSSL.Low_Level.bio_h.BIO;
      c_out : access OpenSSL.Low_Level.bio_h.BIO;
   ...
   function SMIME_read_PKCS7 (the_bio : access OpenSSL.Low_Level.bio_h.BIO; bcont : System.Address) return access PKCS7;  -- openssl/pkcs7.h:385
   pragma Import (C, SMIME_read_PKCS7, "SMIME_read_PKCS7");

   function BIO_new_PKCS7 (c_out : access OpenSSL.Low_Level.bio_h.BIO; p7 : access PKCS7) return access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/pkcs7.h:387
