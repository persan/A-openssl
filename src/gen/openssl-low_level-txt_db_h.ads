...
package OpenSSL.Low_Level.txt_db_h is
   ...
   function TXT_DB_read (c_in : access OpenSSL.Low_Level.bio_h.BIO; num : int) return access TXT_DB;  -- openssl/txt_db.h:96
   pragma Import (C, TXT_DB_read, "TXT_DB_read");

   function TXT_DB_write (c_out : access OpenSSL.Low_Level.bio_h.BIO; db : access TXT_DB) return long;  -- openssl/txt_db.h:97
