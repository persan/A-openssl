...
package OpenSSL.Low_Level.pem_h is
   ...
   function PEM_write_bio_X509 (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.x509_h.x509_st) return int;  -- openssl/pem.h:459
   ...
   function PEM_write_bio_X509_AUX (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.x509_h.x509_st) return int;  -- openssl/pem.h:461
   ...
   function PEM_write_bio_X509_CERT_PAIR (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.x509_h.X509_CERT_PAIR) return int;  -- openssl/pem.h:463
   ...
   function PEM_write_bio_X509_REQ (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.x509_h.X509_REQ) return int;  -- openssl/pem.h:465
   ...
   function PEM_write_bio_X509_REQ_NEW (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.x509_h.X509_REQ) return int;  -- openssl/pem.h:466
   ...
   function PEM_write_bio_X509_CRL (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.x509_h.X509_crl_st) return int;  -- openssl/pem.h:468
   ...
   function PEM_write_bio_PKCS7 (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.pkcs7_h.PKCS7) return int;  -- openssl/pem.h:470
   ...
   function PEM_write_bio_NETSCAPE_CERT_SEQUENCE (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.x509_h.NETSCAPE_CERT_SEQUENCE) return int;  -- openssl/pem.h:472
   ...
   function PEM_write_bio_PKCS8 (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.x509_h.X509_SIG) return int;  -- openssl/pem.h:474
   ...
   function PEM_write_bio_PKCS8_PRIV_KEY_INFO (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.x509_h.pkcs8_priv_key_info_st) return int;  -- openssl/pem.h:476
   ...
   function PEM_write_bio_RSAPublicKey (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access constant OpenSSL.Low_Level.rsa_h.rsa_st) return int;  -- openssl/pem.h:482
   ...
   function PEM_write_bio_RSA_PUBKEY (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.rsa_h.rsa_st) return int;  -- openssl/pem.h:483
   ...
   function PEM_write_bio_DSA_PUBKEY (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.dsa_h.dsa_st) return int;  -- openssl/pem.h:491
   ...
   function PEM_write_bio_DSAparams (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access constant OpenSSL.Low_Level.dsa_h.dsa_st) return int;  -- openssl/pem.h:493
   ...
   function PEM_write_bio_DHparams (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access constant OpenSSL.Low_Level.dh_h.dh_st) return int;  -- openssl/pem.h:500
   ...
   function PEM_write_bio_PUBKEY (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.evp_h.evp_pkey_st) return int;  -- openssl/pem.h:506
   ...
   function PEM_read_bio_Parameters (bp : access OpenSSL.Low_Level.bio_h.BIO; x : System.Address) return access OpenSSL.Low_Level.evp_h.evp_pkey_st;  -- openssl/pem.h:536
   pragma Import (C, PEM_read_bio_Parameters, "PEM_read_bio_Parameters");

   function PEM_write_bio_Parameters (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.evp_h.evp_pkey_st) return int;  -- openssl/pem.h:537
   ...
   function b2i_PrivateKey_bio (c_in : access OpenSSL.Low_Level.bio_h.BIO) return access OpenSSL.Low_Level.evp_h.evp_pkey_st;  -- openssl/pem.h:542
   pragma Import (C, b2i_PrivateKey_bio, "b2i_PrivateKey_bio");

   function b2i_PublicKey_bio (c_in : access OpenSSL.Low_Level.bio_h.BIO) return access OpenSSL.Low_Level.evp_h.evp_pkey_st;  -- openssl/pem.h:543
   pragma Import (C, b2i_PublicKey_bio, "b2i_PublicKey_bio");

   function i2b_PrivateKey_bio (c_out : access OpenSSL.Low_Level.bio_h.BIO; pk : access OpenSSL.Low_Level.evp_h.evp_pkey_st) return int;  -- openssl/pem.h:544
   pragma Import (C, i2b_PrivateKey_bio, "i2b_PrivateKey_bio");

   function i2b_PublicKey_bio (c_out : access OpenSSL.Low_Level.bio_h.BIO; pk : access OpenSSL.Low_Level.evp_h.evp_pkey_st) return int;  -- openssl/pem.h:545
   pragma Import (C, i2b_PublicKey_bio, "i2b_PublicKey_bio");

   function b2i_PVK_bio
     (c_in : access OpenSSL.Low_Level.bio_h.BIO;
      cb : access function
        (arg1 : Interfaces.C.Strings.chars_ptr;
         arg2 : int;
         arg3 : int;
