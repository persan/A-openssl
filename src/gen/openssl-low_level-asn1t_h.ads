...
package OpenSSL.Low_Level.asn1t_h is
   ...
   type ASN1_PRINT_ARG_st is record
      c_out : access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/asn1t.h:733
   ...
   type ASN1_STREAM_ARG_st is record
      c_out : access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/asn1t.h:741
      ndef_bio : access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/asn1t.h:743
