...
package OpenSSL.Low_Level.rsa_h is
   ...
   type rsa_meth_st is record
      ...
      rsa_mod_exp : access function
           (arg1 : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
            arg2 : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
            arg3 : System.Address;
            arg4 : System.Address) return int;  -- openssl/rsa.h:115
      bn_mod_exp : access function
           (arg1 : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
            arg2 : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
            arg3 : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
            arg4 : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
            arg5 : System.Address;
            arg6 : access OpenSSL.Low_Level.ossl_typ_h.BN_MONT_CTX) return int;  -- openssl/rsa.h:118
      ...
      rsa_keygen : access function
           (arg1 : System.Address;
            ...
            arg4 : access OpenSSL.Low_Level.ossl_typ_h.BN_GENCB) return int;  -- openssl/rsa.h:141
   end record;
   ...
   type rsa_st is record
      ...
      meth : access constant OpenSSL.Low_Level.rsa_h.rsa_st_METHOD;  -- openssl/rsa.h:150
      the_engine : System.Address;  -- openssl/rsa.h:152
      n : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/rsa.h:153
      e : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/rsa.h:154
      d : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/rsa.h:155
      p : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/rsa.h:156
      q : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/rsa.h:157
      dmp1 : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/rsa.h:158
      dmq1 : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/rsa.h:159
      iqmp : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;  -- openssl/rsa.h:160
      ...
      u_method_mod_n : access OpenSSL.Low_Level.ossl_typ_h.BN_MONT_CTX;  -- openssl/rsa.h:167
      u_method_mod_p : access OpenSSL.Low_Level.ossl_typ_h.BN_MONT_CTX;  -- openssl/rsa.h:168
      u_method_mod_q : access OpenSSL.Low_Level.ossl_typ_h.BN_MONT_CTX;  -- openssl/rsa.h:169
   ...
   function RSA_generate_key_ex
     (the_rsa : access OpenSSL.Low_Level.rsa_h.rsa_st;
      bits : int;
      e : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      cb : access OpenSSL.Low_Level.ossl_typ_h.BN_GENCB) return int;  -- openssl/rsa.h:286
   pragma Import (C, RSA_generate_key_ex, "RSA_generate_key_ex");

   function RSA_X931_derive_ex
     (the_rsa : access OpenSSL.Low_Level.rsa_h.rsa_st;
      p1 : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      p2 : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      q1 : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      q2 : access OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      Xp1 : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      Xp2 : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      Xp : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      Xq1 : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      Xq2 : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      Xq : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      e : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      cb : access OpenSSL.Low_Level.ossl_typ_h.BN_GENCB) return int;  -- openssl/rsa.h:287
   ...
   function RSA_X931_generate_key_ex
     (the_rsa : access OpenSSL.Low_Level.rsa_h.rsa_st;
      bits : int;
      e : access constant OpenSSL.Low_Level.ossl_typ_h.BIGNUM;
      cb : access OpenSSL.Low_Level.ossl_typ_h.BN_GENCB) return int;  -- openssl/rsa.h:291
   ...
   procedure RSA_set_default_method (meth : access constant OpenSSL.Low_Level.rsa_h.rsa_st_METHOD);  -- openssl/rsa.h:309
   pragma Import (C, RSA_set_default_method, "RSA_set_default_method");

   function RSA_get_default_method return access constant OpenSSL.Low_Level.rsa_h.rsa_st_METHOD;  -- openssl/rsa.h:310
   pragma Import (C, RSA_get_default_method, "RSA_get_default_method");

   function RSA_get_method (the_rsa : access constant OpenSSL.Low_Level.rsa_h.rsa_st) return access constant OpenSSL.Low_Level.rsa_h.rsa_st_METHOD;  -- openssl/rsa.h:311
   pragma Import (C, RSA_get_method, "RSA_get_method");

   function RSA_set_method (the_rsa : access OpenSSL.Low_Level.rsa_h.rsa_st; meth : access constant OpenSSL.Low_Level.rsa_h.rsa_st_METHOD) return int;  -- openssl/rsa.h:312
   ...
   function RSA_PKCS1_SSLeay return access constant OpenSSL.Low_Level.rsa_h.rsa_st_METHOD;  -- openssl/rsa.h:318
   pragma Import (C, RSA_PKCS1_SSLeay, "RSA_PKCS1_SSLeay");

   function RSA_null_method return access constant OpenSSL.Low_Level.rsa_h.rsa_st_METHOD;  -- openssl/rsa.h:320
