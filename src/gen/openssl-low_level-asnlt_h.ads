...
package OpenSSL.Low_Level.asnlt_h is
   ...
   type ASN1_TEMPLATE_st is record
      ...
      item       : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st;  -- openssl/asn1t.h:453
   end record;
   ...
   type ASN1_ADB_st is record
      ...
      default_tt : access constant OpenSSL.Low_Level.asnlt_h.ASN1_TEMPLATE_st;  -- openssl/asn1t.h:470
      null_tt    : access constant OpenSSL.Low_Level.asnlt_h.ASN1_TEMPLATE_st;  -- openssl/asn1t.h:471
   end record;
   ...
   type ASN1_ADB_TABLE_st is record
      ...
      tt    : aliased OpenSSL.Low_Level.asnlt_h.ASN1_TEMPLATE_st;  -- openssl/asn1t.h:476
   end record;
   ...
   type ASN1_ITEM_st is record
      ...
      templates : access constant OpenSSL.Low_Level.asnlt_h.ASN1_TEMPLATE_st;  -- openssl/asn1t.h:571
   ...
   type ASN1_EXTERN_FUNCS_st is record
      ...
      asn1_ex_new   : access function (arg1 : System.Address; arg2 : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:683
      asn1_ex_free  : access procedure (arg1 : System.Address; arg2 : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st);  -- openssl/asn1t.h:684
      asn1_ex_clear : access procedure (arg1 : System.Address; arg2 : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st);  -- openssl/asn1t.h:685
      asn1_ex_d2i   : access function
        (arg1 : System.Address;
         arg2          : System.Address;
         arg3          : long;
         arg4          : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st;
         arg5          : int;
         arg6          : int;
         arg7          : char;
         arg8          : access OpenSSL.Low_Level.asnlt_h.ASN1_TLC_st) return int;  -- openssl/asn1t.h:686
      asn1_ex_i2d   : access function
        (arg1 : System.Address;
         arg2          : System.Address;
         arg3          : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st;
         arg4          : int;
   ...
   type ASN1_PRIMITIVE_FUNCS_st is record
      ...
      prim_new   : access function (arg1 : System.Address; arg2 : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:694
      prim_free  : access procedure (arg1 : System.Address; arg2 : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st);  -- openssl/asn1t.h:695
      prim_clear : access procedure (arg1 : System.Address; arg2 : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st);  -- openssl/asn1t.h:696
      prim_c2i   : access function
        (arg1 : System.Address;
         ...
         arg6       : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:697
      prim_i2c   : access function
        (arg1 : System.Address;
         arg2       : access unsigned_char;
         arg3       : access int;
         arg4       : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:698
   ...
   ASN1_BOOLEAN_it : aliased OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st;  -- openssl/asn1t.h:913
   pragma Import (C, ASN1_BOOLEAN_it, "ASN1_BOOLEAN_it");

   ASN1_TBOOLEAN_it : aliased OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st;  -- openssl/asn1t.h:914
   pragma Import (C, ASN1_TBOOLEAN_it, "ASN1_TBOOLEAN_it");

   ASN1_FBOOLEAN_it : aliased OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st;  -- openssl/asn1t.h:915
   pragma Import (C, ASN1_FBOOLEAN_it, "ASN1_FBOOLEAN_it");

   ASN1_SEQUENCE_it : aliased OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st;  -- openssl/asn1t.h:916
   pragma Import (C, ASN1_SEQUENCE_it, "ASN1_SEQUENCE_it");

   CBIGNUM_it : aliased OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st;  -- openssl/asn1t.h:917
   pragma Import (C, CBIGNUM_it, "CBIGNUM_it");

   BIGNUM_it : aliased OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st;  -- openssl/asn1t.h:918
   pragma Import (C, BIGNUM_it, "BIGNUM_it");

   LONG_it : aliased OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st;  -- openssl/asn1t.h:919
   pragma Import (C, LONG_it, "LONG_it");

   ZLONG_it : aliased OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st;  -- openssl/asn1t.h:920
   ...
   function ASN1_item_ex_new (pval : System.Address; it : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:926
   pragma Import (C, ASN1_item_ex_new, "ASN1_item_ex_new");

   procedure ASN1_item_ex_free (pval : System.Address; it : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st);  -- openssl/asn1t.h:927
   pragma Import (C, ASN1_item_ex_free, "ASN1_item_ex_free");

   function ASN1_template_new (pval : System.Address; tt : access constant OpenSSL.Low_Level.asnlt_h.ASN1_TEMPLATE_st) return int;  -- openssl/asn1t.h:928
   pragma Import (C, ASN1_template_new, "ASN1_template_new");

   function ASN1_primitive_new (pval : System.Address; it : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:929
   pragma Import (C, ASN1_primitive_new, "ASN1_primitive_new");

   procedure ASN1_template_free (pval : System.Address; tt : access constant OpenSSL.Low_Level.asnlt_h.ASN1_TEMPLATE_st);  -- openssl/asn1t.h:931
   ...
   function ASN1_template_d2i
     (pval : System.Address;
      c_in : System.Address;
      len  : long;
      tt   : access constant OpenSSL.Low_Level.asnlt_h.ASN1_TEMPLATE_st) return int;  -- openssl/asn1t.h:932
   ...
   function ASN1_item_ex_d2i
     (pval   : System.Address;
      ...
      aclass : int;
      opt    : char;
      ctx    : access OpenSSL.Low_Level.asnlt_h.ASN1_TLC_st) return int;  -- openssl/asn1t.h:933
   ...
   function ASN1_template_i2d
     (pval  : System.Address;
      c_out : System.Address;
      tt    : access constant OpenSSL.Low_Level.asnlt_h.ASN1_TEMPLATE_st) return int;  -- openssl/asn1t.h:937
   pragma Import (C, ASN1_template_i2d, "ASN1_template_i2d");

   procedure ASN1_primitive_free (pval : System.Address; it : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st);  -- openssl/asn1t.h:938
   ...
   function asn1_ex_i2c
     (pval   : System.Address;
      ...
      putype : access int;
      it     : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:940
   ...
   function asn1_ex_c2i
     (pval      : System.Address;
      ...
      it        : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:941
   pragma Import (C, asn1_ex_c2i, "asn1_ex_c2i");

   function asn1_get_choice_selector (pval : System.Address; it : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:943
   pragma Import (C, asn1_get_choice_selector, "asn1_get_choice_selector");

   function asn1_set_choice_selector
     (pval  : System.Address;
      value : int;
      it    : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:944
   pragma Import (C, asn1_set_choice_selector, "asn1_set_choice_selector");

   function asn1_get_field_ptr (pval : System.Address; tt : access constant OpenSSL.Low_Level.asnlt_h.ASN1_TEMPLATE_st) return System.Address;  -- openssl/asn1t.h:946
   pragma Import (C, asn1_get_field_ptr, "asn1_get_field_ptr");

   function asn1_do_adb
     (pval    : System.Address;
      tt      : access constant OpenSSL.Low_Level.asnlt_h.ASN1_TEMPLATE_st;
      nullerr : int) return access constant OpenSSL.Low_Level.asnlt_h.ASN1_TEMPLATE_st;  -- openssl/asn1t.h:948
   pragma Import (C, asn1_do_adb, "asn1_do_adb");

   function asn1_do_lock
     (pval : System.Address;
      op   : int;
      it   : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:950
   pragma Import (C, asn1_do_lock, "asn1_do_lock");

   procedure asn1_enc_init (pval : System.Address; it : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st);  -- openssl/asn1t.h:952
   pragma Import (C, asn1_enc_init, "asn1_enc_init");

   procedure asn1_enc_free (pval : System.Address; it : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st);  -- openssl/asn1t.h:953
   ...
   function asn1_enc_restore
     (len   : access int;
      c_out : System.Address;
      pval  : System.Address;
      it    : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:954
   ...
   function asn1_enc_save
     (pval  : System.Address;
      ...
      inlen : int;
      it    : access constant OpenSSL.Low_Level.asnlt_h.ASN1_ITEM_st) return int;  -- openssl/asn1t.h:955
   pragma Import (C, asn1_enc_save, "asn1_enc_save");

end OpenSSL.Low_Level.asnlt_h;
