...
package OpenSSL.Low_Level.dsa_h is
   ...
   type DSA_SIG_st is record
      r : access OpenSSL.Low_Level.bn_h.bignum_st;  -- openssl/dsa.h:127
      s : access OpenSSL.Low_Level.bn_h.bignum_st;  -- openssl/dsa.h:128
   end record;
   ...
   type dsa_method is record
      ...
      dsa_mod_exp    : access function
        (arg1 : System.Address;
         ...
         arg4           : access OpenSSL.Low_Level.bn_h.bignum_st;
         arg5           : access OpenSSL.Low_Level.bn_h.bignum_st;
         arg6           : access OpenSSL.Low_Level.bn_h.bignum_st;
         arg7           : access OpenSSL.Low_Level.bn_h.bignum_st;
         arg8           : System.Address;
         arg9           : access OpenSSL.Low_Level.bn_h.bn_mont_ctx_st) return int;  -- openssl/dsa.h:141
      bn_mod_exp     : access function
        (arg1 : System.Address;
         ...
         arg6           : System.Address;
         arg7           : access OpenSSL.Low_Level.bn_h.bn_mont_ctx_st) return int;  -- openssl/dsa.h:144
      ...
      dsa_paramgen   : access function
        (arg1 : System.Address;
         ...
         arg7           : access OpenSSL.Low_Level.bn_h.bn_gencb_st) return int;  -- openssl/dsa.h:153
   ...
   type dsa_st is record
      ...
      p             : access OpenSSL.Low_Level.bn_h.bignum_st;  -- openssl/dsa.h:165
      q             : access OpenSSL.Low_Level.bn_h.bignum_st;  -- openssl/dsa.h:166
      g             : access OpenSSL.Low_Level.bn_h.bignum_st;  -- openssl/dsa.h:167
      pub_key       : access OpenSSL.Low_Level.bn_h.bignum_st;  -- openssl/dsa.h:169
      priv_key      : access OpenSSL.Low_Level.bn_h.bignum_st;  -- openssl/dsa.h:170
      kinv          : access OpenSSL.Low_Level.bn_h.bignum_st;  -- openssl/dsa.h:172
      r             : access OpenSSL.Low_Level.bn_h.bignum_st;  -- openssl/dsa.h:173
   ...
   function DSA_generate_parameters_ex
     (the_dsa     : access OpenSSL.Low_Level.dsa_h.dsa_st;
      ...
      counter_ret : access int;
      h_ret       : access unsigned_long;
      cb          : access OpenSSL.Low_Level.bn_h.bn_gencb_st) return int;  -- openssl/dsa.h:239
   ...
   function DSAparams_print (bp : access OpenSSL.Low_Level.bio_h.bio_st; x : access constant OpenSSL.Low_Level.dsa_h.dsa_st) return int;  -- openssl/dsa.h:249
