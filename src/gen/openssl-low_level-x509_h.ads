...
package OpenSSL.Low_Level.x509_h is
   ...
   type X509_algor_st is record
      algorithm : access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;  -- openssl/x509.h:137
      parameter : access OpenSSL.Low_Level.asn1_h.ASN1_TYPE;  -- openssl/x509.h:138
   end record;
   ...
   type X509_name_entry_st is record
      object : access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;  -- openssl/x509.h:166
   ...
   type X509_extension_st is record
      object : access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;  -- openssl/x509.h:196
   ...
   type anon_30 (discr : unsigned := 0) is record
      case discr is
         ...
         when others =>
            single : access OpenSSL.Low_Level.asn1_h.ASN1_TYPE;  -- openssl/x509.h:214
      end case;
   end record;
   pragma Convention (C_Pass_By_Copy, anon_30);
   pragma Unchecked_Union (anon_30);
   type x509_attributes_st is record
      object : access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;  -- openssl/x509.h:209
   ...
   type Netscape_certificate_sequence is record
      c_type : access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;  -- openssl/x509.h:538
   ...
   type PBKDF2PARAM_st is record
      salt : access OpenSSL.Low_Level.asn1_h.ASN1_TYPE;  -- openssl/x509.h:564
   ...
   type pkcs8_priv_key_info_st is record
      ...
      pkey : access OpenSSL.Low_Level.asn1_h.ASN1_TYPE;  -- openssl/x509.h:583
   ...
   function NETSCAPE_SPKI_print (c_out : access OpenSSL.Low_Level.bio_h.BIO; spki : access NETSCAPE_SPKI) return int;  -- openssl/x509.h:649
   ...
   function d2i_X509_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; the_x509 : System.Address) return access OpenSSL.Low_Level.x509_h.x509_st;  -- openssl/x509.h:704
   pragma Import (C, d2i_X509_bio, "d2i_X509_bio");

   function i2d_X509_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; the_x509 : access OpenSSL.Low_Level.x509_h.x509_st) return int;  -- openssl/x509.h:705
   pragma Import (C, i2d_X509_bio, "i2d_X509_bio");

   function d2i_X509_CRL_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; crl : System.Address) return access OpenSSL.Low_Level.x509_h.X509_crl_st;  -- openssl/x509.h:706
   pragma Import (C, d2i_X509_CRL_bio, "d2i_X509_CRL_bio");

   function i2d_X509_CRL_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; crl : access OpenSSL.Low_Level.x509_h.X509_crl_st) return int;  -- openssl/x509.h:707
   pragma Import (C, i2d_X509_CRL_bio, "i2d_X509_CRL_bio");

   function d2i_X509_REQ_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; req : System.Address) return access X509_REQ;  -- openssl/x509.h:708
   pragma Import (C, d2i_X509_REQ_bio, "d2i_X509_REQ_bio");

   function i2d_X509_REQ_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; req : access X509_REQ) return int;  -- openssl/x509.h:709
   pragma Import (C, i2d_X509_REQ_bio, "i2d_X509_REQ_bio");

   function d2i_RSAPrivateKey_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; the_rsa : System.Address) return access OpenSSL.Low_Level.rsa_h.rsa_st;  -- openssl/x509.h:711
   pragma Import (C, d2i_RSAPrivateKey_bio, "d2i_RSAPrivateKey_bio");

   function i2d_RSAPrivateKey_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; the_rsa : access OpenSSL.Low_Level.rsa_h.rsa_st) return int;  -- openssl/x509.h:712
   pragma Import (C, i2d_RSAPrivateKey_bio, "i2d_RSAPrivateKey_bio");

   function d2i_RSAPublicKey_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; the_rsa : System.Address) return access OpenSSL.Low_Level.rsa_h.rsa_st;  -- openssl/x509.h:713
   pragma Import (C, d2i_RSAPublicKey_bio, "d2i_RSAPublicKey_bio");

   function i2d_RSAPublicKey_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; the_rsa : access OpenSSL.Low_Level.rsa_h.rsa_st) return int;  -- openssl/x509.h:714
   pragma Import (C, i2d_RSAPublicKey_bio, "i2d_RSAPublicKey_bio");

   function d2i_RSA_PUBKEY_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; the_rsa : System.Address) return access OpenSSL.Low_Level.rsa_h.rsa_st;  -- openssl/x509.h:715
   pragma Import (C, d2i_RSA_PUBKEY_bio, "d2i_RSA_PUBKEY_bio");

   function i2d_RSA_PUBKEY_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; the_rsa : access OpenSSL.Low_Level.rsa_h.rsa_st) return int;  -- openssl/x509.h:716
   pragma Import (C, i2d_RSA_PUBKEY_bio, "i2d_RSA_PUBKEY_bio");

   function d2i_DSA_PUBKEY_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; the_dsa : System.Address) return access OpenSSL.Low_Level.dsa_h.dsa_st;  -- openssl/x509.h:719
   pragma Import (C, d2i_DSA_PUBKEY_bio, "d2i_DSA_PUBKEY_bio");

   function i2d_DSA_PUBKEY_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; the_dsa : access OpenSSL.Low_Level.dsa_h.dsa_st) return int;  -- openssl/x509.h:720
   pragma Import (C, i2d_DSA_PUBKEY_bio, "i2d_DSA_PUBKEY_bio");

   function d2i_DSAPrivateKey_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; the_dsa : System.Address) return access OpenSSL.Low_Level.dsa_h.dsa_st;  -- openssl/x509.h:721
   pragma Import (C, d2i_DSAPrivateKey_bio, "d2i_DSAPrivateKey_bio");

   function i2d_DSAPrivateKey_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; the_dsa : access OpenSSL.Low_Level.dsa_h.dsa_st) return int;  -- openssl/x509.h:722
   pragma Import (C, i2d_DSAPrivateKey_bio, "i2d_DSAPrivateKey_bio");

   function d2i_PKCS8_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; p8 : System.Address) return access X509_SIG;  -- openssl/x509.h:724
   pragma Import (C, d2i_PKCS8_bio, "d2i_PKCS8_bio");

   function i2d_PKCS8_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; p8 : access X509_SIG) return int;  -- openssl/x509.h:725
   pragma Import (C, i2d_PKCS8_bio, "i2d_PKCS8_bio");

   function d2i_PKCS8_PRIV_KEY_INFO_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; p8inf : System.Address) return access OpenSSL.Low_Level.x509_h.pkcs8_priv_key_info_st;  -- openssl/x509.h:726
   pragma Import (C, d2i_PKCS8_PRIV_KEY_INFO_bio, "d2i_PKCS8_PRIV_KEY_INFO_bio");

   function i2d_PKCS8_PRIV_KEY_INFO_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; p8inf : access OpenSSL.Low_Level.x509_h.pkcs8_priv_key_info_st) return int;  -- openssl/x509.h:728
   pragma Import (C, i2d_PKCS8_PRIV_KEY_INFO_bio, "i2d_PKCS8_PRIV_KEY_INFO_bio");

   function i2d_PKCS8PrivateKeyInfo_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; key : access OpenSSL.Low_Level.evp_h.evp_pkey_st) return int;  -- openssl/x509.h:729
   pragma Import (C, i2d_PKCS8PrivateKeyInfo_bio, "i2d_PKCS8PrivateKeyInfo_bio");

   function i2d_PrivateKey_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; pkey : access OpenSSL.Low_Level.evp_h.evp_pkey_st) return int;  -- openssl/x509.h:730
   pragma Import (C, i2d_PrivateKey_bio, "i2d_PrivateKey_bio");

   function d2i_PrivateKey_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; a : System.Address) return access OpenSSL.Low_Level.evp_h.evp_pkey_st;  -- openssl/x509.h:731
   pragma Import (C, d2i_PrivateKey_bio, "d2i_PrivateKey_bio");

   function i2d_PUBKEY_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; pkey : access OpenSSL.Low_Level.evp_h.evp_pkey_st) return int;  -- openssl/x509.h:732
   pragma Import (C, i2d_PUBKEY_bio, "i2d_PUBKEY_bio");

   function d2i_PUBKEY_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; a : System.Address) return access OpenSSL.Low_Level.evp_h.evp_pkey_st;  -- openssl/x509.h:733
   ...
   function X509_ALGOR_set0
     (alg : access OpenSSL.Low_Level.x509_h.X509_algor_st;
      aobj : access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;
      ptype : int;
   ...
   function X509_add1_trust_object (x : access OpenSSL.Low_Level.x509_h.x509_st; obj : access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT) return int;  -- openssl/x509.h:826
   pragma Import (C, X509_add1_trust_object, "X509_add1_trust_object");

   function X509_add1_reject_object (x : access OpenSSL.Low_Level.x509_h.x509_st; obj : access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT) return int;  -- openssl/x509.h:827
   ...
   function X509_REQ_add1_attr_by_OBJ
     (req : access X509_REQ;
      obj : access constant OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;
      c_type : int;
   ...
   function X509_print (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.x509_h.x509_st) return int;  -- openssl/x509.h:964
   pragma Import (C, X509_print, "X509_print");

   function X509_ocspid_print (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.x509_h.x509_st) return int;  -- openssl/x509.h:965
   ...
   function X509_CRL_print (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access OpenSSL.Low_Level.x509_h.X509_crl_st) return int;  -- openssl/x509.h:967
   ...
   function X509_REQ_print (bp : access OpenSSL.Low_Level.bio_h.BIO; req : access X509_REQ) return int;  -- openssl/x509.h:969
   ...
   function X509_NAME_ENTRY_set_object (ne : access X509_NAME_ENTRY; obj : access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT) return int;  -- openssl/x509.h:1000
   ...
   function X509_NAME_ENTRY_get_object (ne : access X509_NAME_ENTRY) return access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;  -- openssl/x509.h:1004
   ...
   function X509_EXTENSION_set_object (ex : access X509_EXTENSION; obj : access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT) return int;  -- openssl/x509.h:1056
   ...
   function X509_EXTENSION_get_object (ex : access X509_EXTENSION) return access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;  -- openssl/x509.h:1060
   ...
   function X509_ATTRIBUTE_set1_object (attr : access X509_ATTRIBUTE; obj : access constant OpenSSL.Low_Level.asn1_h.ASN1_OBJECT) return int;  -- openssl/x509.h:1090
   ...
   function X509_ATTRIBUTE_get0_object (attr : access X509_ATTRIBUTE) return access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;  -- openssl/x509.h:1095
   pragma Import (C, X509_ATTRIBUTE_get0_object, "X509_ATTRIBUTE_get0_object");

   function X509_ATTRIBUTE_get0_type (attr : access X509_ATTRIBUTE; idx : int) return access OpenSSL.Low_Level.asn1_h.ASN1_TYPE;  -- openssl/x509.h:1096
   ...
   function X509_verify_cert (ctx : access OpenSSL.Low_Level.x509_vfy_h.x509_store_st_CTX) return int;  -- openssl/x509.h:1116
