...
package OpenSSL.Low_Level.cms_h is
   ...
   function CMS_get0_type (cms : System.Address) return access constant OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;  -- openssl/cms.h:115
   pragma Import (C, CMS_get0_type, "CMS_get0_type");

   function CMS_dataInit (cms : System.Address; icont : access OpenSSL.Low_Level.bio_h.BIO) return access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/cms.h:117
   pragma Import (C, CMS_dataInit, "CMS_dataInit");

   function CMS_dataFinal (cms : System.Address; the_bio : access OpenSSL.Low_Level.bio_h.BIO) return int;  -- openssl/cms.h:118
   ...
   function PEM_write_bio_CMS (bp : access OpenSSL.Low_Level.bio_h.BIO; x : System.Address) return int;  -- openssl/cms.h:125
   ...
   function d2i_CMS_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; cms : System.Address) return System.Address;  -- openssl/cms.h:129
   pragma Import (C, d2i_CMS_bio, "d2i_CMS_bio");

   function i2d_CMS_bio (bp : access OpenSSL.Low_Level.bio_h.BIO; cms : System.Address) return int;  -- openssl/cms.h:130
   pragma Import (C, i2d_CMS_bio, "i2d_CMS_bio");

   function BIO_new_CMS (c_out : access OpenSSL.Low_Level.bio_h.BIO; cms : System.Address) return access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/cms.h:132
   ...
   function SMIME_read_CMS (the_bio : access OpenSSL.Low_Level.bio_h.BIO; bcont : System.Address) return System.Address;  -- openssl/cms.h:135
   ...
   function CMS_final
     (cms : System.Address;
      data : access OpenSSL.Low_Level.bio_h.BIO;
      dcont : access OpenSSL.Low_Level.bio_h.BIO;
   ...
   function CMS_data_create (c_in : access OpenSSL.Low_Level.bio_h.BIO; flags : unsigned) return System.Address;  -- openssl/cms.h:149
   ...
   function CMS_add0_recipient_key
     (cms : System.Address;
      ...
      otherTypeId : access OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;
      otherType : access OpenSSL.Low_Level.asn1_h.ASN1_TYPE) return System.Address;  -- openssl/cms.h:202
   ...
   function CMS_set1_eContentType (cms : System.Address; oid : access constant OpenSSL.Low_Level.asn1_h.ASN1_OBJECT) return int;  -- openssl/cms.h:228
   pragma Import (C, CMS_set1_eContentType, "CMS_set1_eContentType");

   function CMS_get0_eContentType (cms : System.Address) return access constant OpenSSL.Low_Level.asn1_h.ASN1_OBJECT;  -- openssl/cms.h:229
   ...
   function CMS_SignerInfo_verify_content (si : System.Address; chain : access OpenSSL.Low_Level.bio_h.BIO) return int;  -- openssl/cms.h:258
