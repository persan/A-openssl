...
package OpenSSL.Low_Level.ssl_h is
   ...
   SSL_TXT_ADH : aliased constant String := "ADH" & ASCII.NUL;  --  openssl/ssl.h:270
   ...
   SSL_TXT_AECDH : aliased constant String := "AECDH" & ASCII.NUL;  --  openssl/ssl.h:274
   ...
   type ssl_ctx_st is record
      ...
      app_verify_callback : access function (arg1 : access OpenSSL.Low_Level.x509_vfy_h.x509_store_st_CTX; arg2 : System.Address) return int;  -- openssl/ssl.h:743
      ...
      default_verify_callback : access function (arg1 : int; arg2 : access OpenSSL.Low_Level.x509_vfy_h.x509_store_st_CTX) return int;  -- openssl/ssl.h:799
   ...
   type ssl_st is record
      ...
      rbio : access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/ssl.h:973
      wbio : access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/ssl.h:974
      bbio : access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/ssl.h:975
      ...
      verify_callback : access function (arg1 : int; arg2 : access OpenSSL.Low_Level.x509_vfy_h.x509_store_st_CTX) return int;  -- openssl/ssl.h:1086
      info_callback : access procedure
           (arg1 : access constant OpenSSL.Low_Level.ssl_h.ssl_st;
            arg2 : int;
   ...
   function PEM_write_bio_SSL_SESSION (bp : access OpenSSL.Low_Level.bio_h.BIO; x : access SSL_SESSION) return int;  -- openssl/ssl.h:1281
   ...
   function BIO_f_ssl return access OpenSSL.Low_Level.bio_h.BIO_METHOD;  -- openssl/ssl.h:1447
   pragma Import (C, BIO_f_ssl, "BIO_f_ssl");

   function BIO_new_ssl (ctx : access OpenSSL.Low_Level.ssl_h.ssl_ctx_st; client : int) return access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/ssl.h:1448
   pragma Import (C, BIO_new_ssl, "BIO_new_ssl");

   function BIO_new_ssl_connect (ctx : access OpenSSL.Low_Level.ssl_h.ssl_ctx_st) return access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/ssl.h:1449
   pragma Import (C, BIO_new_ssl_connect, "BIO_new_ssl_connect");

   function BIO_new_buffer_ssl_connect (ctx : access OpenSSL.Low_Level.ssl_h.ssl_ctx_st) return access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/ssl.h:1450
   pragma Import (C, BIO_new_buffer_ssl_connect, "BIO_new_buffer_ssl_connect");

   function BIO_ssl_copy_session_id (to : access OpenSSL.Low_Level.bio_h.BIO; from : access OpenSSL.Low_Level.bio_h.BIO) return int;  -- openssl/ssl.h:1451
   pragma Import (C, BIO_ssl_copy_session_id, "BIO_ssl_copy_session_id");

   procedure BIO_ssl_shutdown (ssl_bio : access OpenSSL.Low_Level.bio_h.BIO);  -- openssl/ssl.h:1452
   ...
   procedure SSL_set_bio
     (s : access OpenSSL.Low_Level.ssl_h.ssl_st;
      rbio : access OpenSSL.Low_Level.bio_h.BIO;
      wbio : access OpenSSL.Low_Level.bio_h.BIO);  -- openssl/ssl.h:1486
   pragma Import (C, SSL_set_bio, "SSL_set_bio");

   function SSL_get_rbio (s : access constant OpenSSL.Low_Level.ssl_h.ssl_st) return access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/ssl.h:1487
   pragma Import (C, SSL_get_rbio, "SSL_get_rbio");

   function SSL_get_wbio (s : access constant OpenSSL.Low_Level.ssl_h.ssl_st) return access OpenSSL.Low_Level.bio_h.BIO;  -- openssl/ssl.h:1488
   ...
   function SSL_get_verify_callback (s : access constant OpenSSL.Low_Level.ssl_h.ssl_st) return access function (arg1 : int; arg2 : access OpenSSL.Low_Level.x509_vfy_h.x509_store_st_CTX) return int;  -- openssl/ssl.h:1494
   pragma Import (C, SSL_get_verify_callback, "SSL_get_verify_callback");

   procedure SSL_set_verify
     (s : access OpenSSL.Low_Level.ssl_h.ssl_st;
      mode : int;
      callback : access function (arg1 : int; arg2 : access OpenSSL.Low_Level.x509_vfy_h.x509_store_st_CTX) return int);  -- openssl/ssl.h:1495
   ...
   function SSL_SESSION_print (fp : access OpenSSL.Low_Level.bio_h.BIO; ses : System.Address) return int;  -- openssl/ssl.h:1545
   ...
   function SSL_CTX_get_verify_callback (ctx : access constant OpenSSL.Low_Level.ssl_h.ssl_ctx_st) return access function (arg1 : int; arg2 : access OpenSSL.Low_Level.x509_vfy_h.x509_store_st_CTX) return int;  -- openssl/ssl.h:1567
   pragma Import (C, SSL_CTX_get_verify_callback, "SSL_CTX_get_verify_callback");

   procedure SSL_CTX_set_verify
     (ctx : access OpenSSL.Low_Level.ssl_h.ssl_ctx_st;
      mode : int;
      callback : access function (arg1 : int; arg2 : access OpenSSL.Low_Level.x509_vfy_h.x509_store_st_CTX) return int);  -- openssl/ssl.h:1568
   ...
   procedure SSL_CTX_set_cert_verify_callback
     (ctx : access OpenSSL.Low_Level.ssl_h.ssl_ctx_st;
      cb : access function (arg1 : access OpenSSL.Low_Level.x509_vfy_h.x509_store_st_CTX; arg2 : System.Address) return int;
